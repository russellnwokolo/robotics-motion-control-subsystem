# Hardware/Firmware Subsystem 
This subsystem contains a custom PCB and firmware for controlling dual-axis stepper motors for a pan-tilt robotics system project for the Robotics and Advanced Tech Society.
